<script>
    ;(function () {
        ...
        $(document).on('click','.media_library_image_delete_btn',function (e) {
            e.preventDefault();
            console.log($('.img-meta .image_id').text());
            $.ajax({
                type: "POST",
...
<?php /**PATH C:\wamp64\www\businessmanagement\@core\resources\views/backend/partials/media-upload/media-js.blade.php ENDPATH**/ ?>